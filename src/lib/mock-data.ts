...
export const mockProducts: Product[] = [
  ...
  { id: '4', name: 'Café em Pó 500g', category: 'Copa', quantity: 25, unitPrice: 18.90, totalPrice: 472.50, unit: 'BH-Algar', minStock: 10 },
  { id: '5', name: 'Água Mineral 20L', category: 'Copa', quantity: 12, unitPrice: 15.00, totalPrice: 180, unit: 'BH-Matriz', minStock: 5 },
  { id: '6', name: 'Álcool Gel 500ml', category: 'Limpeza', quantity: 40, unitPrice: 12.90, totalPrice: 516, unit: 'BH-Algar', minStock: 15 },
...
export const mockMovements: StockMovement[] = [
  ...
  { id: '3', productId: '4', productName: 'Café em Pó 500g', type: 'saida', quantity: 5, date: '2026-03-13', user: 'Admin', responsible: 'Maria Santos', notes: 'Reposição copa', unit: 'BH-Algar' },
...
export const mockCollaborators: Collaborator[] = [
  ...
  { id: '2', name: 'Maria Santos', unit: 'BH-Algar', department: 'Administrativo', active: true },
  ...
  { id: '5', name: 'Pedro Henrique', unit: 'BH-Algar', department: 'Operações', active: false },
];

export const mockAssets: AssetItem[] = [
  { id: '1', code: '3ARI-BH-001', name: 'Notebook Dell Latitude 5540', description: 'Notebook corporativo i7 16GB', category: 'Informática', quantity: 1, unitPrice: 6500, totalPrice: 6500, branch: 'BH-Matriz', acquisitionDate: '2025-06-15' },
  { id: '2', code: '3ARI-BH-002', name: 'Monitor LG 27" 4K', description: 'Monitor ultrawide para análise', category: 'Informática', quantity: 1, unitPrice: 2800, totalPrice: 2800, branch: 'BH-Matriz', acquisitionDate: '2025-06-15' },
  { id: '3', code: '3ARI-BH-003', name: 'Cadeira Ergonômica', description: 'Cadeira presidente com apoio lombar', category: 'Mobiliário', quantity: 1, unitPrice: 1890, totalPrice: 1890, branch: 'BH-Matriz', acquisitionDate: '2025-03-10' },
  { id: '4', code: '3ARI-SP-001', name: 'Notebook Dell Latitude 5540', description: 'Notebook corporativo i7 16GB', category: 'Informática', quantity: 1, unitPrice: 6500, totalPrice: 6500, branch: 'SP', acquisitionDate: '2025-08-20' },
  { id: '5', code: '3ARI-SP-002', name: 'Impressora HP LaserJet', description: 'Impressora multifuncional laser', category: 'Informática', quantity: 1, unitPrice: 3200, totalPrice: 3200, branch: 'SP', acquisitionDate: '2025-09-01' },
  { id: '6', code: '3ARI-RJ-001', name: 'Mesa de Reunião 8 lugares', description: 'Mesa oval em MDF', category: 'Mobiliário', quantity: 1, unitPrice: 4500, totalPrice: 4500, branch: 'RJ', acquisitionDate: '2025-07-05' },
  { id: '7', code: '3ARI-BH-004', name: 'Ar Condicionado Split 18000BTU', description: 'Split inverter Samsung', category: 'Climatização', quantity: 1, unitPrice: 3800, totalPrice: 3800, branch: 'BH-Algar', acquisitionDate: '2025-04-12' },
  { id: '8', code: '3ARI-FLO-001', name: 'Notebook Lenovo ThinkPad', description: 'Notebook corporativo i5 8GB', category: 'Informática', quantity: 1, unitPrice: 4200, totalPrice: 4200, branch: 'FLO', acquisitionDate: '2025-11-10' },
];
