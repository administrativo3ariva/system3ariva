...
export const mockAssets: AssetItem[] = [
  ...
  { id: '7', code: '3ARI-BH-004', name: 'Ar Condicionado Split 18000BTU', description: 'Split inverter Samsung', category: 'Climatização', quantity: 1, unitPrice: 3800, totalPrice: 3800, branch: 'BH-Algar', acquisitionDate: '2025-04-12', imageUrl: 'https://images.unsplash.com/photo-1585338107529-13afc5f02586?w=100&h=100&fit=crop' },
