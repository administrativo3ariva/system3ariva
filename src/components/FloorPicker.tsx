...
const floorMeta: Record<string, { short: string; color: string }> = {
  ...
  'Algar': { short: 'ALG', color: 'bg-purple-500/15 text-purple-400 border-purple-500/30 hover:bg-purple-500/25' },
};
        ...
        {BH_MATRIZ_FLOORS.map(floor => {
          ...
          return (
            ...
            >
              ...
              {floor !== 'Algar' && <span className="text-[10px] opacity-70">andar</span>}
            </button>
          );
        })}
      </div>
